...
class BiljkaListAdapter(private var biljkee: List<Biljka>, private var moda: Mod, private val listener: BiljkaClickListener, private val glavnaListaBiljke: MutableList<Biljka>, private var klik: Boolean ) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (moda) {
            ...
            Mod.Botanicki -> {
                ...
                BiljkaViewHolderBotanicki(view, listener, glavnaListaBiljke, true)
            }
        }
    }
    ...
    fun updatePlants(newList: List<Biljka>) {
        biljkee = newList
        notifyDataSetChanged()
    }
    fun setKlik (klikanje: Boolean){
        klik = klikanje
        notifyDataSetChanged()
    }
