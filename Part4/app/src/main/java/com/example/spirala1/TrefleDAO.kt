    ...
    suspend fun getImage(biljka: Biljka): Bitmap {
        return withContext(Dispatchers.IO) {
            try {
                ...
                val url1 = "http://trefle.io/api/v1/species?filter[scientific_name]=$latinName&token=gzkmCLq1YXtDVKPEBTC7LpkS6MiwoJ99FCKKGHLp7s4"
                val url = URL(url1)
    ...
    suspend fun getPlantsWithFlowerColor(
        ...
        return withContext(Dispatchers.IO) {
            ...
            try {
                ...
                val searchUrl = URL("http://trefle.io/api/v1/plants/search?token=gzkmCLq1YXtDVKPEBTC7LpkS6MiwoJ99FCKKGHLp7s4&q=$substr&filter_not[flower_color]=null")
                (searchUrl.openConnection() as? HttpURLConnection)?.run {
                    ...
                    for (i in 0 until searchResults.length()) {
                        ...
                        val speciesUrl = URL("http://trefle.io/api/v1/species/$plantId?token=gzkmCLq1YXtDVKPEBTC7LpkS6MiwoJ99FCKKGHLp7s4")
